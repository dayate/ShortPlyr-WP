!(function (e, t) {
    ...
    _ = {
      ...
      logInfo: function (e) {
        for (
          ...
          n[o - 1] = arguments[o];
        this.config.debug >= 3 &&
          (t = console).log.apply(t, [C, b.info, e].concat(n));
      },
      logWarn: function (e) {
        for (
          var t, i = arguments.length, n = new Array(i > 1 ? i - 1 : 0), o = 1;
          ...
          n[o - 1] = arguments[o];
        this.config.debug >= 1 &&
          (t = console).warn.apply(t, [C, b.warn, e].concat(n));
      },
      logError: function (e) {
        var t;
        if (!(this.config.debug < 1)) {
          for (
            ...
            o[r - 1] = arguments[r];
          (t = console)[i].apply(t, [C, b.error, e].concat(o));
        }
      },
    };
  var w = (function () {
  ...
  ((T.createDom = function () {
    ...
    (T.createDomFromHtml = function (e) {
      var t =
      ...
      try {
        ...
        return (_.logError('util.createDomFromHtml', r), null);
      }
    }),
    ...
    (T.toggleClass = function (e, t) {
      e &&
        t.split(/\s+/g).forEach(function (t) {
          T.hasClass(e, t) ? T.removeClass(e, t) : T.addClass(e, t);
        });
    }),
    ...
    (T.format = function (e) {
      ...
      e = Math.round(e);
      var t = T.padStart(Math.floor(e / 3600), 2, 0),
        i = T.padStart(Math.floor((e - 3600 * t) / 60), 2, 0),
        n = T.padStart(Math.floor(e - 3600 * t - 60 * i), 2, 0);
    ...
    (T.deepCopy = function (e, t) {
      if ('Object' === T.typeOf(t) && 'Object' === T.typeOf(e))
        return (
          Object.keys(t).forEach(function (i) {
            'Object' !== T.typeOf(t[i]) || t[i] instanceof Node
              ? 'Array' === T.typeOf(t[i])
                ? (e[i] = 'Array' === T.typeOf(e[i]) ? e[i].concat(t[i]) : t[i])
                : (e[i] = t[i])
    ...
    (T.deepMerge = function (e, t) {
      return (
        Object.keys(t).map(function (i) {
          var n;
          'Array' === T.typeOf(t[i]) && 'Array' === T.typeOf(e[i])
            ? 'Array' === T.typeOf(e[i]) && (n = e[i]).push.apply(n, g(t[i]))
            : T.typeOf(e[i]) !== T.typeOf(t[i]) ||
                null === e[i] ||
                'Object' !== T.typeOf(e[i]) ||
    ...
    (T.createImgBtn = function (e, t, i, n) {
      var o,
        r,
        s,
        a = T.createDom('xg-'.concat(e), '', {}, 'xgplayer-'.concat(e, '-img'));
    ...
    (T.checkIsFunction = function (e) {
      return e && 'function' == typeof e;
    }),
    (T.checkIsObject = function (e) {
    ...
    (T.setStyleFromCsstext = function (e, t) {
      t &&
        ('String' === T.typeOf(t)
          ? t
              .replace(/\s+/g, '')
    ...
    (T.filterStyleFromText = function (e) {
      var t =
      ...
      return (
        n.map(function (e) {
          if (e) {
            var i = e.split(':');
            i.length > 1 && (x(i[0], t) ? (o[i[0]] = i[1]) : (r[i[0]] = i[1]));
          }
        }),
    ...
    (T.getStyleFromCsstext = function (e) {
    ...
    (T.checkTouchSupport = function () {
      return 'ontouchstart' in window;
    }),
    (T.getBuffered2 = function (e) {
      for (
        var t =
            arguments.length > 1 && void 0 !== arguments[1]
              ? arguments[1]
    ...
    (T.adjustTimeByDuration = function (e, t, i) {
      return t && e && (e > t || (i && e < t)) ? t : e;
    }),
    (T.createPositionBar = function (e, t) {
      var i = T.createDom('xg-bar', '', { 'data-index': -1 }, e);
      return (t.appendChild(i), i);
    }),
    (T.getTransformStyle = function () {
      var e =
          arguments.length > 0 && void 0 !== arguments[0]
            ? arguments[0]
    ...
    (T.convertDeg = function (e) {
      return Math.abs(e) <= 1 ? 360 * e : e % 360;
    }),
    (T.getIndexByTime = function (e, t) {
      var i = t.length,
        n = -1;
      if (i < 1) return n;
    ...
    (T.getOffsetCurrentTime = function (e, t) {
      var i =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : -1,
        n = -1;
      if ((n = i >= 0 && i < t.length ? i : T.getIndexByTime(e, t)) < 0)
        return -1;
      var o = t.length,
        r = t[n],
        s = r.start,
    ...
    (T.getCurrentTimeByOffset = function (e, t) {
      var i = -1;
  ...
  var P = {
    ...
    I = { 1: 5101, 2: 5102, 3: 5103, 4: 5104, 5: 5105, 6: 5106 },
    L = r(function e(t) {
      var i =
        arguments.length > 1 && void 0 !== arguments[1]
          ? arguments[1]
      ...
      if (arguments.length > 1) {
        for (
          var v = { playerVersion: m, domain: document.domain },
            y = [
              'errorType',
              'currentTime',
              'duration',
    ...
    J = 'urlNull',
    $ = 'autoplay_started',
    Q = 'autoplay_was_prevented',
    ee = 'complete',
    te = 'replay',
    ie = 'destroy',
    ne = 'urlchange',
    oe = 'download_speed_change',
    re = 'leaveplayer',
    se = 'enterplayer',
    ae = 'loading',
    le = 'fullscreen_change',
    ce = 'cssFullscreen_change',
    ue = 'mini_state_change',
    he = 'definition_change',
    de = 'after_definition_change',
    fe = 'video_resize',
    pe = 'pip_change',
    ge = 'rotate',
    ve = 'screenShot',
      ...
      Object.defineProperty(
        {
          ...
          URL_NULL: J,
          AUTOPLAY_STARTED: $,
          AUTOPLAY_PREVENTED: Q,
          COMPLETE: ee,
          REPLAY: te,
          DESTROY: ie,
          URL_CHANGE: ne,
          DOWNLOAD_SPEED_CHANGE: oe,
          LEAVE_PLAYER: re,
          ENTER_PLAYER: se,
          LOADING: ae,
          FULLSCREEN_CHANGE: le,
          CSS_FULLSCREEN_CHANGE: ce,
          MINI_STATE_CHANGE: ue,
          DEFINITION_CHANGE: he,
          BEFORE_DEFINITION_CHANGE: 'before_definition_change',
          AFTER_DEFINITION_CHANGE: de,
  ...
  var Ie = Pe.exports,
          ...
          [
            {
              ...
              value: function (e) {
                e &&
                  ((Le[e.playerId] = e),
                  1 === Object.keys(Le).length &&
                    this.setActive(e.playerId, !0));
              },
            },
            {
              key: 'remove',
              value: function (e) {
                e && (e.isUserActive, delete Le[e.playerId]);
              },
            },
            {
              key: '_iterate',
              value: function (e) {
                var t =
                  ...
                  arguments[1];
                for (var i in Le)
                  if (Object.prototype.hasOwnProperty.call(Le, i)) {
                    var n = Le[i];
                    if (t) {
                      if (e(n)) break;
                    } else e(n);
                  ...
                  return (
                    t
                      ? this.forEach(function (t) {
                          e === t.playerId
                            ? ((t.isUserActive = !0), (t.isInstNext = !1))
                            : (t.isUserActive = !1);
                        })
                      : (Le[e].isUserActive = t),
                    e
            ...
            },
            {
              key: 'getActiveId',
              value: function () {
                for (var e = Object.keys(Le), t = 0; t < e.length; t++) {
                  var i = Le[e[t]];
                  if (i && i.isUserActive) return e[t];
                }
                return null;
              },
            },
                ...
                if (Le[e])
                  return (
                    t
                      ? this.forEach(function (t) {
                          e === t.playerId
                            ? ((t.isUserActive = !1), (t.isInstNext = !0))
                            : (t.isInstNext = !1);
                        })
                      : (Le[e].isInstNext = t),
                    e
    ...
    })(Pe.exports.EventEmitter);
  var De = { lang: {}, langKeys: [], textKeys: [] };
  function Re(e, t) {
    return (
      Object.keys(t).forEach(function (i) {
        var n,
  ...
  function Me() {
    Object.keys(De.lang.en).map(function (e) {
      De.textKeys[e] = e;
    });
  }
  function je(e, t) {
    ...
    if ((t || (t = De), t.lang)) {
      var n = e.TEXT || {};
      ('zh' === i && (i = 'zh-cn'),
        t.lang[i] ? Re(t.lang[i], n) : (t.langKeys.push(i), (t.lang[i] = n)),
        Me());
    }
  }
  je({
  ...
  var Ne = {
      ...
      get lang() {
        var e = {};
        return (
          De.langKeys.map(function (t) {
            e[t] = De.lang[t];
          }),
          De.lang['zh-cn'] && (e.zh = De.lang['zh-cn'] || {}),
          e
        );
      },
      extend: function (e, t) {
        ...
        if ((t || (t = De), t.lang)) {
          ...
          (i.map(function (e) {
            ('zh' === e.LANG && (e.LANG = 'zh-cn'),
              n[e.LANG] ? Re(n[e.LANG] || {}, e.TEXT || {}) : je(e, t));
          }),
            Me());
        }
      },
      ...
      init: function (e) {
        ...
        return (
          Re(i.lang, De.lang),
          (t = i.langKeys).push.apply(t, g(De.langKeys)),
          Re(i.textKeys, De.textKeys),
          i
        );
      },
    },
    ...
    Ue = {
      ...
      get os() {
        ...
        var e = navigator.userAgent,
          ...
          l = a || (r && !/(?:Mobile)/.test(e)) || (s && /(?:Tablet)/.test(e)),
          c = /(?:iPhone)/.test(e) && !l;
        return {
          isTablet: l,
          isPhone: c,
      ...
      get osVersion() {
        ...
        var e = navigator.userAgent,
          t = '',
          i = (t = /(?:iPhone)|(?:iPad|PlayBook)/.test(e) ? He : Fe)
            ? t.exec(e)
            : [];
        if (i && i.length >= 3) {
          var n = i[2].split('.');
  ...
  function Ve(e, t) {
    return function (i, n) {
      var o = {
        ...
        muted: t.muted,
        volume: t.volume,
        host: T.getHostFromUrl(t.currentSrc),
        vtype: t.vtype,
      };
      if (
  ...
  var Ge = (function (e) {
      ...
      function i(e) {
        ...
        return (
          ...
          (o.media =
            e.mediaEl instanceof HTMLMediaElement
              ? e.mediaEl
              : 'function' == typeof e.mediaEl
                ? e.mediaEl(o.mediaConfig)
                : T.createDom(o.mediaConfig.mediaType, '', o.mediaConfig, '')),
          e.defaultPlaybackRate &&
            (o.media.defaultPlaybackRate = o.media.playbackRate =
              e.defaultPlaybackRate),
          'Number' === T.typeOf(e.volume) && (o.volume = e.volume),
          e.autoplayMuted && ((o.media.muted = !0), (o._lastMuted = !0)),
          e.autoplay && (o.media.autoplay = !0),
          e.playsinline && (o.media.playsinline = !0),
          (o._interval = {}),
          ...
          },
          {
            ...
            get: function () {
              return this.media && this.media.buffered
                ? T.getBuffered2(this.media.buffered)
                : null;
            },
          },
          {
      ...
      function () {
        ...
        if (this.__hooks && this.__hooks[e])
          try {
            var s = rt.apply(
              void 0,
              [this, e, t].concat(Array.prototype.slice.call(arguments)),
            );
            s
              ? s.then
                ? s
                    .then(function (e) {
                      !1 !== e && Ze.apply(void 0, [o, t, i.next].concat(g(n)));
                    })
                    .catch(function (e) {
                      throw e;
                    })
  ...
  function $e(e, t) {
    var i = this.__hooks;
    if (!i || !Array.isArray(i[e])) return -1;
    for (var n = i[e], o = 0; o < n.length; o++) if (n[o] === t) return o;
    return -1;
  }
  function Qe(e, t) {
    var i = this.__hooks;
    if (i)
      return i.hasOwnProperty(e)
        ? (Array.isArray(i[e]) || (i[e] = []),
          -1 === $e.call(this, e, t) && i[e].push(t),
          !0)
  ...
  function rt(e, t, i) {
    for (
      ...
      o[r - 3] = arguments[r];
    if (e.__hooks && Array.isArray(e.__hooks[t])) {
      var s = e.__hooks[t],
        a = -1,
        l = function e(t, i, n) {
          for (
            var o = arguments.length, r = new Array(o > 3 ? o - 3 : 0), l = 3;
            l < o;
            l++
          )
            r[l - 3] = arguments[l];
          if ((a++, 0 === s.length || a === s.length))
            return n.call.apply(n, [t, t].concat(r));
          var c = s[a],
            u = c.call.apply(c, [t, t].concat(r));
          return u && u.then
            ? u
                .then(function (o) {
                  return !1 === o ? null : e.apply(void 0, [t, i, n].concat(r));
                })
                .catch(function (e) {
                  console.warn('[runHooks]'.concat(i, ' reject'), e.message);
                })
            : !1 !== u
              ? e.apply(void 0, [t, i, n].concat(r))
              : !1 !== u && void 0;
        };
      return l.apply(void 0, [e, t, i].concat(o));
    }
  ...
  var at = (function () {
    function e(t) {
      (n(this, e),
        T.checkIsFunction(this.beforeCreate) && this.beforeCreate(t),
        nt(this),
        (this.__args = t),
        (this.__events = {}),
        (this.__onceEvents = {}),
      ...
      r(
        ...
        [
          ...
          },
          {
            key: 'domEventType',
            get: function () {
              var e = T.checkTouchSupport() ? 'touch' : 'mouse';
              return (
                !this.playerConfig ||
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              e && t && this.player
                ...
                : st(this.pluginName, 'plugin.on(event, callback)');
            },
          },
          {
            key: 'once',
            value: function (e, t) {
              ...
              e && t && this.player
                ...
                : st(this.pluginName, 'plugin.once(event, callback)');
            },
          },
          {
            key: 'off',
            value: function (e, t) {
              ...
              e && t && this.player
                ...
                : st(this.pluginName, 'plugin.off(event, callback)');
            },
          },
          {
            key: 'offAll',
          ...
          },
          {
            ...
            value: function () {
              var e = this,
                ...
                i = this.pluginName;
              (this.offAll(),
                T.clearAllTimers(this),
                T.checkIsFunction(this.destroy) && this.destroy(),
                [
                  'player',
                  'playerConfig',
                  'pluginName',
  ...
  function ht(e, t, i, n) {
    return function (i) {
      ((i.delegateTarget = ct(i.target, t)), i.delegateTarget && n.call(e, i));
    };
  }
  var dt = function (e, t, i, n, o) {
      return 'function' == typeof e.addEventListener
        ? ut.apply(null, arguments)
        : 'function' == typeof i
          ? ut.bind(null, document).apply(null, arguments)
          : ('string' == typeof e && (e = document.querySelectorAll(e)),
            Array.prototype.map.call(e, function (e) {
              return ut(e, t, i, n, o);
            }));
    },
    ft = { CONTROLS: 'controls', ROOT: 'root' },
    pt = {
      ROOT: 'root',
      ROOT_LEFT: 'rootLeft',
  ...
  function yt(e, t) {
    ...
    if (vt(e) || vt(e.url))
      return (
        (n.src = vt(e) ? e : e.url || ''),
        (r = T.createDom(e.tag || 'img', '', n, 'xg-img '.concat(i)))
      );
    if ('function' == typeof e)
      try {
        ...
        return (
          _.logError('Plugin named ['.concat(o, ']:createIcon'), s),
          null
        );
      }
    return 'string' == typeof e
      ? T.createDomFromHtml(e, n, i)
      : (_.logWarn(
          'warn>>icons.'
            .concat(t, ' in config of plugin named [')
            .concat(o, '] is invalid'),
  ...
  function mt(e, t) {
    ...
    Object.keys(e).map(function (o) {
      ...
      (n &&
        ...
        (l = yt(n[o], o, s, a, t.pluginName))),
        !l && r && (l = yt(r.icon ? r.icon : r, a, s, {}, t.pluginName)),
        (t.icons[o] = l));
    });
  }
  var kt = (function (e) {
              ...
              value: function (e) {
                if ((p(l(o.prototype), '__init', this).call(this, e), e.root)) {
                  ...
                  if (a)
                    ...
                    if (!e.tag) return;
                    ((i = T.createDom(e.tag, '', e.attr, e.name)).setAttribute(
                      'data-index',
                      e.index,
                    ),
                      t.appendChild(i));
                    ...
                    Object.keys(t).map(function (n) {
                      ...
                      ('function' == typeof a
                        ...
                        : 'object' === i(a) &&
                          ...
                          ((o = a.options
                            ? T.deepCopy(e.config[s] || {}, a.options)
                            : e.config[s] || {}),
                          (r = a.plugin)),
                        (l.config = o),
            ...
            },
            {
              ...
              value: function () {
                ((this.config.disable = !0),
                  T.addClass(this.find('.xgplayer-icon'), gt));
              },
            },
            {
              key: 'enable',
              value: function () {
                ((this.config.disable = !1),
                  T.removeClass(this.find('.xgplayer-icon'), gt));
              },
            },
            {
              key: 'children',
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                try {
                  ...
                  return (_.logError('Plugin:appendChild', i), null);
                }
              },
            },
            {
            ...
            ((this.observer = new window.ResizeObserver(
              (function (e, t, i) {
                ...
                return (
                  ...
                  E(e, t, { leading: n, trailing: o, maxWait: t })
                );
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              try {
                var i;
                null === (i = this.observer) || void 0 === i || i.unobserve(e);
              } catch (n) {}
  ...
  var _t = {
              ...
              for (var a = Object.keys(r), l = 0; l < a.length; l++)
                if (s.toLowerCase() === a[l].toLowerCase()) {
                  ...
                  'Object' === T.typeOf(c)
                    ...
                    : 'Boolean' === T.typeOf(c) && (i.config.disable = !c);
                  break;
                }
              (t.defaultConfig &&
      ...
      destroy: function (e) {
        ...
        if (this.pluginGroup[t]) {
          var i, n, o;
          ((i = e.root),
            null === (o = Ct) || void 0 === o || o.unObserver(i, n));
          for (
            var r = this.pluginGroup[t]._plugins, s = 0, a = Object.keys(r);
            s < a.length;
            s++
          ) {
            var l = a[s];
          ...
          (delete this.pluginGroup[t], delete e._pluginInfoId);
        }
      },
    },
    wt = {
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  o = t.mode;
                if (!i) {
                  'flex' === o && this.player.addClass(wt.FLEX_CONTROLS);
                  ...
                  (Object.keys(r).map(function (t) {
                    ...
                    this.on(ue, function (t) {
                      t
                        ? T.addClass(e.root, 'mini-controls')
                        : T.removeClass(e.root, 'mini-controls');
                    }));
            ...
            },
            {
              ...
              value: function () {
                this.config.autoHide &&
                  T.addClass(this.root, wt.CONTROLS_AUTOHIDE);
              },
            },
            {
              key: 'pauseAutoHide',
              value: function () {
                T.removeClass(this.root, wt.CONTROLS_AUTOHIDE);
              },
            },
            {
              key: 'show',
                  ...
                  if (!t.root) {
                    var r = t.position
                      ...
                      : t.config && t.config.position
                        ...
                        : o.position;
                    switch (r) {
                      case pt.CONTROLS_LEFT:
                        t.root = this.left;
                        break;
                      case pt.CONTROLS_RIGHT:
                        t.root = this.right;
                        break;
                      case pt.CONTROLS_CENTER:
                        t.root = this.center;
                        break;
                      case pt.CONTROLS:
                        t.root = this.root;
      ...
      function o(e) {
        ...
        (s(u((t = i.call(this, a))), 'canPlayFunc', function () {
          if (t.config) {
            ...
            (_.logInfo('player', 'canPlayFunc, startTime', t.__startTime),
              t._seekToStartTime(),
              (t.playbackRate = n),
              (i || t._useAutoplay) && t.mediaPlay(),
              t.off(B, t.canPlayFunc),
              t.removeClass(wt.ENTER));
          }
        }),
          s(u(t), 'onFullscreenChange', function (e, i) {
            ...
            if (i || (o && (o === t._fullscreenEl || r)))
              (n(),
                ...
                (t.fullscreen = !0),
                t.changeFullStyle(t.root, o, wt.FULLSCREEN),
                t.emit(le, !0, t._fullScreenOffset),
              ...
              if (
                ...
                t.removeClass(wt.FULLSCREEN);
              else {
                var l = t._fullscreenEl;
                (l ||
                  (!t.root.contains(e.target) && e.target !== t.root) ||
                  (l = e.target),
                  t.recoverFullStyle(t.root, l, wt.FULLSCREEN));
              }
              ((t._fullscreenEl = null), t.emit(le, !1));
            }
          }),
          ...
          nt(u(t), Rt),
          (t.config = a),
          (t._pluginInfoId = T.generateSessionId()),
          ((r = u(t)).logInfo = _.logInfo.bind(r)),
          (r.logWarn = _.logWarn.bind(r)),
          (r.logError = _.logError.bind(r)));
        ...
        if (
          ...
          (t.topBar = null),
          (t.root = null),
          (t.__i18n = Ne.init(t._pluginInfoId)),
          Ue.os.isAndroid &&
            Ue.osVersion > 0 &&
            Ue.osVersion < 6 &&
            (t.config.autoplay = !1),
          ...
          [
            {
              ...
              value: function () {
                ...
                var n = (function (e) {
                  for (var t = Object.keys(Le), i = 0; i < t.length; i++) {
                    var n = Le[t[i]];
                ...
                if (
                  (n &&
                    ...
                    n.destroy()),
                  this.root.setAttribute(Xe, this.playerId),
                  this.media.setAttribute(Xe, this.playerId),
                  null === (e = Nt) || void 0 === e || e.add(this),
                  _t.init(this),
                  this._initBaseDoms(),
                  this.config.controls)
                ) {
                  var o = this.config.controls.root || null,
                    r = _t.register(this, Dt, { root: o });
                  this.controls = r;
                }
                var s =
                ...
                if (
                  (this.addClass(
                    ''
                      .concat(wt.DEFAULT, ' ')
                      .concat(wt.INACTIVE, ' xgplayer-')
                      .concat(s, ' ')
                      .concat(this.config.controls ? '' : wt.NO_CONTROLS),
                  ),
                  this.config.autoplay
                    ? this.addClass(wt.ENTER)
                    : this.addClass(wt.NO_START),
                  this.config.fluid)
                ) {
                  var a = this.config,
                    l = a.width,
                    c = a.height;
                  ('number' == typeof l && 'number' == typeof c) ||
                    ((l = 600), (c = 337.5));
                  var u = {
                    width: '100%',
                    height: '0',
                    'max-width': '100%',
                    'padding-top': ''.concat((100 * c) / l, '%'),
                  };
                  ...
                  ['width', 'height'].forEach(function (e) {
                    t.config[e] &&
                      ('number' != typeof t.config[e]
                        ? (t.root.style[e] = t.config[e])
                        : (t.root.style[e] = ''.concat(t.config[e], 'px')));
                  });
                var h = this.root.getBoundingClientRect(),
                  d = h.width,
                  f = h.height,
                  p = h.left,
                  g = h.top;
                return (
                  (this.sizeInfo.width = d),
                  (this.sizeInfo.height = f),
                  (this.sizeInfo.left = p),
                  (this.sizeInfo.top = g),
                  !0
                );
              },
              ...
              value: function () {
                ((this.topBar = null),
                  ...
                  this.config.marginControls &&
                    ((this.innerContainer = T.createDom(
                      'xg-video-container',
                      '',
                      { 'data-index': -1 },
                      'xg-video-container',
            ...
            },
            {
              ...
              value: function () {
                ...
                (['focus', 'blur'].forEach(function (t) {
                  ...
                  this.once(V, this.resize),
                  (this.playFunc = function () {
                    e.config.closeFocusVideoFocus || e.media.focus();
                  }),
                  this.once(A, this.playFunc));
              },
            },
            {
              key: '_unbindEvents',
              value: function () {
                ...
                (this.root.removeEventListener('mousemove', this.mousemoveFunc),
                  ...
                  this.playFunc && this.off(A, this.playFunc),
                  this.off(B, this.canPlayFunc),
            ...
            },
            {
              ...
              value: function () {
                this.userTimer &&
                  (T.clearTimeout(this, this.userTimer),
                  (this.userTimer = null));
              },
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  (T.isNotNull(i.playSessionId) &&
                    (this._playSessionId = i.playSessionId),
                    this.handleSource &&
                      (this._detachSourceEvents(this.media),
                      'Array' === T.typeOf(e) && e.length > 0
                        ? this._attachSourceEvents(this.media, e)
                        : this.media.src && this.media.src === e
                          ? e || this.media.removeAttribute('src')
                          : (this.media.src = e)),
                    'Number' === T.typeOf(this.config.volume) &&
                      (this.volume = this.config.volume));
                  var n = this.innerContainer ? this.innerContainer : this.root;
                  this.media instanceof window.Element &&
                    !n.contains(this.media) &&
                    n.insertBefore(this.media, n.firstChild);
                  var o = this.media.readyState;
                  (_.logInfo('_startInit readyState', o),
                    this.config.autoplay &&
                      (!T.isMSE(this.media) && this.load(),
                      (Ue.os.isIpad || Ue.os.isPhone) && this.mediaPlay()));
                  var r = this.config.startTime;
                  ((this.__startTime = r > 0 ? r : -1),
                    (this.config.startTime = 0),
                    o >= 2 && this.duration > 0
                      ? this.canPlayFunc()
                      : this.on(B, this.canPlayFunc),
                    (!this.hasStart || this.state < Pt) && _t.afterInit(this),
                    (this.hasStart = !0),
                    this.setState(Pt),
                    T.setTimeout(
                      this,
                    ...
                    if (i.lazy && i.loader) {
                      ...
                      return void (
                        ...
                        (o
                          ...
                          .catch(function (t) {
                            (_.logError('_registerPlugins:loadingPlugin', t),
                              e._loadingPlugins.splice(
                                e._loadingPlugins.indexOf(o),
                                1,
                              ));
            ...
            },
            {
              ...
              value: function (e) {
                ...
                switch (e) {
                  case pt.ROOT_RIGHT:
                    (this.rightBar ||
                      (this.rightBar = T.createPositionBar(
                        'xg-right-bar',
                        this.root,
                      )),
                      (t = this.rightBar));
                  ...
                  case pt.ROOT_LEFT:
                    (this.leftBar ||
                      (this.leftBar = T.createPositionBar(
                        'xg-left-bar',
                        this.root,
                      )),
                      (t = this.leftBar));
                  ...
                  case pt.ROOT_TOP:
                    (this.topBar ||
                      ((this.topBar = T.createPositionBar(
                        'xg-top-bar',
                        this.root,
                      )),
                      this.config.topBarAutoHide &&
                        T.addClass(this.topBar, wt.TOP_BAR_AUTOHIDE)),
                      (t = this.topBar));
                    break;
                  default:
            ...
            },
            {
              key: 'registerPlugin',
              value: function (e, t) {
                var i = _t.formatPluginInfo(e, t),
                  n = i.PLUFGIN,
                  o = i.options,
                  r = this.config.plugins;
                !_t.checkPluginIfExits(n.pluginName, r) && r.push(n);
                var s = _t.getRootByConfig(n.pluginName, this.config);
                ...
                return !o.root &&
                  ...
                  ? null === (a = this.controls) || void 0 === a
                    ? void 0
                    : a.registerPlugin(n, o, n.pluginName)
                  : (o.root || (o.root = this._getRootByPosition(l)),
                    _t.register(this, n, o));
              },
            },
            {
              key: 'deregister',
              value: function (e) {
                'string' == typeof e
                  ? _t.unRegister(this, e)
                  : e instanceof at && _t.unRegister(this, e.pluginName);
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ('string' == typeof e
                    ? (t = e)
                    : e instanceof at && (t = e.pluginName),
                  t)
                )
            ...
            },
            {
              key: 'plugins',
              get: function () {
                return _t.getPlugins(this);
              },
            },
            {
              key: 'getPlugin',
              value: function (e) {
                var t = _t.findPlugin(this, e);
            ...
            },
            {
              ...
              value: function (e) {
                this.root &&
                  (T.hasClass(this.root, e) || T.addClass(this.root, e));
              },
            },
            {
              key: 'removeClass',
              value: function (e) {
                this.root && T.removeClass(this.root, e);
              },
            },
            {
              key: 'hasClass',
              value: function (e) {
                if (this.root) return T.hasClass(this.root, e);
              },
            },
            {
              key: 'setAttribute',
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (!(this.state > Et)) {
                  ...
                  return (
                    T.isNotNull(i) && (this._playSessionId = void 0),
                    ...
                    _t
                      ...
                      .then(function () {
                        if (t.config) {
                          ...
                          var n = t.preProcessUrl(e);
                          return t._startInit(n.url, { playSessionId: i });
                        }
                      })
                      .catch(function (e) {
                        throw (
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                if (!this.hasStart && this.state < Pt)
                  return (
                    this.removeClass(wt.NO_START),
                    this.addClass(wt.ENTER),
                    this.start(),
                ...
                this.state < Lt &&
                  (this.removeClass(wt.NO_START),
                  !this.isCanplay && this.addClass(wt.ENTER));
                var t = p(l(o.prototype), 'play', this).call(this);
                return (
                  void 0 !== t && t && t.then
                    ? t
                        .then(function () {
                          (e.removeClass(wt.NOT_ALLOW_AUTOPLAY),
                            e.addClass(wt.PLAYING),
                            e.state < Lt &&
                              (_.logInfo('>>>>playPromise.then'),
                              e.setState(Lt),
                              e.emit($)));
                        })
                        .catch(function (t) {
                          if (
                            (_.logWarn('>>>>playPromise.catch', t.name),
                            e.media && e.media.error)
                          )
                            return (e.onError(), void e.removeClass(wt.ENTER));
                          'NotAllowedError' === t.name &&
                            (e._errorTimer = T.setTimeout(
                              e,
                              function () {
                                ((e._errorTimer = null),
                                  e.emit(Q),
                                  e.addClass(wt.NOT_ALLOW_AUTOPLAY),
                                  e.removeClass(wt.ENTER),
                                  e.pause(),
                                  e.setState(It));
                              },
                              0,
                    ...
                    : (_.logWarn('video.play not return promise'),
                      this.state < Lt &&
                        (this.setState(Lt),
                        this.removeClass(wt.NOT_ALLOW_AUTOPLAY),
                        this.removeClass(wt.NO_START),
                        this.removeClass(wt.ENTER),
                        this.addClass(wt.PLAYING),
                        this.emit($))),
                  t
                );
              },
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                return (
                  this.removeClass(wt.PAUSED),
                  rt(this, 'play', function () {
                    return e.mediaPlay();
                  })
                );
              },
              ...
              value: function (e, t) {
                ...
                if (this.media && !Number.isNaN(Number(e)) && this.hasStart) {
                  ...
                  ((e =
                    ...
                    this._onceSeekCanplay && this.off(N, this._onceSeekCanplay),
                    (this._onceSeekCanplay = function () {
                      switch (
                        (i.removeClass(wt.ENTER), (i.isSeeking = !1), s)
                      ) {
                        case 'play':
                          i.play();
                          break;
                    ...
                    this.once(N, this._onceSeekCanplay),
                    this.state < Lt
                      ? (this.removeClass(wt.NO_START),
                        (this.currentTime = e),
                        this.play())
            ...
            },
            {
              ...
              value: function (e, i) {
                ...
                if (
                  ...
                  r && r.then
                    ? r.then(function () {
                        n.emit(de, { from: i, to: e });
                      })
                    : this.emit(de, { from: i, to: e });
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  var o = Tt();
                  Object.keys(this.config).forEach(function (t) {
              ...
              value: function () {
                ...
                if (n && r) {
                  if (
                    ((this.hasStart = !1),
                    (this._useAutoplay = !1),
                    n.removeAttribute(Xe),
                    r.removeAttribute(Xe),
                    this.updateAcc('destroy'),
                    this._unbindEvents(),
                    this._detachSourceEvents(this.media),
                    T.clearAllTimers(this),
                    this.emit(ie),
                    null === (e = Nt) || void 0 === e || e.remove(this),
                    _t.destroy(this),
                    ot(this),
                    ...
                    for (var s = i.children, a = 0; a < s.length; a++)
                      i.removeChild(s[a]);
                  (!i &&
                    r instanceof window.Node &&
                    n.contains(r) &&
                    !this.config.remainMediaAfterDestroy &&
                    n.removeChild(r),
                    ['topBar', 'leftBar', 'rightBar', 'innerContainer'].map(
                      function (e) {
                        (t[e] && n.removeChild(t[e]), (t[e] = null));
                      },
                    ));
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                (this.removeClass(wt.ENDED),
                  (this.currentTime = 0),
                  (this.isSeeking = !1),
                  rt(this, 'replay', function () {
                    (e.once(N, function () {
                      var t = e.mediaPlay();
                      t &&
                        t.catch &&
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                (this.removeClass(wt.ERROR),
                  this.addClass(wt.LOADING),
                  rt(this, 'retry', function () {
                    var t = e.currentTime,
                      i = e.config.url,
                      n = T.isMSE(e.media) ? { url: i } : e.preProcessUrl(i);
                    ((e.src = n.url),
            ...
            },
            {
              ...
              value: function (e, t, i, n) {
                e &&
                  (n || (n = wt.PARENT_FULLSCREEN),
                  this._orgCss || (this._orgCss = T.filterStyleFromText(e)),
                  T.addClass(e, i),
                  t &&
                    t !== e &&
                    !this._orgPCss &&
                    ((this._orgPCss = T.filterStyleFromText(t)),
                    T.addClass(t, n),
                    t.setAttribute(Xe, this.playerId)));
              },
            },
            {
              ...
              value: function (e, t, i, n) {
                (n || (n = wt.PARENT_FULLSCREEN),
                  this._orgCss &&
                    (T.setStyleFromCsstext(e, this._orgCss),
                    (this._orgCss = '')),
                  T.removeClass(e, i),
                  t &&
                    t !== e &&
                    this._orgPCss &&
                    (T.setStyleFromCsstext(t, this._orgPCss),
                    (this._orgPCss = ''),
                    T.removeClass(t, n),
                    t.removeAttribute(Xe)));
              },
            },
            {
              key: 'getFullscreen',
            ...
            },
            {
              ...
              value: function (e) {
                if (
                  ...
                  this._fullscreenEl || T.getFullScreenEl())
                ) {
                  this.root;
                  var t = this.media;
                  ...
                  try {
                    ...
                    return Promise.reject(
                      new Error('call exitFullscreen fail'),
                    );
                  }
                }
              },
            },
            {
              ...
              value: function () {
                ...
                var t = e
                  ? ''
                      .concat(wt.INNER_FULLSCREEN, ' ')
                      .concat(wt.CSS_FULLSCREEN)
                  : wt.CSS_FULLSCREEN;
                ...
                var i = this.config.fullscreen,
                  ...
                  o =
                    ...
                    ('function' == typeof n.useCssFullscreen &&
                      n.useCssFullscreen());
                (o && ((this.fullscreen = !0), this.emit(le, !0)),
            ...
            },
            {
              ...
              value: function () {
                ...
                var t = e
                  ? ''
                      .concat(wt.INNER_FULLSCREEN, ' ')
                      .concat(wt.ROTATE_FULLSCREEN)
                  : wt.ROTATE_FULLSCREEN;
                ((this._fullscreenEl = e || this.root),
                  this.changeFullStyle(
                    this.root,
                    e,
                    t,
                    wt.PARENT_ROTATE_FULLSCREEN,
                  ),
                ...
                var i =
                  ...
                  90 === Math.abs(screen.orientation.angle);
                ((this.root.style.width = ''.concat(
            ...
            },
            {
              ...
              value: function () {
                (this.removeClass(wt.ENTER),
                  ...
                  (this.isCanplay = !0),
                  this.waitTimer && T.clearTimeout(this, this.waitTimer));
              },
            },
            {
              key: 'onLoadeddata',
            ...
            },
            {
              key: 'onLoadstart',
              value: function () {
                (this.removeClass(wt.ERROR), (this.isCanplay = !1));
              },
            },
            {
              key: 'onPlay',
              value: function () {
                (this.state === At && this.setState(Lt),
                  this.removeClass(wt.PAUSED),
                  this.ended && this.removeClass(wt.ENDED),
            ...
            },
            {
              key: 'onPause',
              value: function () {
                (this.addClass(wt.PAUSED),
                  this.updateAcc('pause'),
                  this.config.closePauseVideoFocus ||
                    (this._clearUserTimer(), this.focus()));
              },
            },
            {
              key: 'onEnded',
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.waitTimer && T.clearTimeout(this, this.waitTimer),
                  ...
                  (this.waitTimer = T.setTimeout(
                    this,
                    function () {
                      (e.addClass(wt.LOADING),
                        e.emit(ae),
                        T.clearTimeout(e, e.waitTimer),
                        (e.waitTimer = null));
                    },
            ...
            },
            {
              ...
              value: function () {
                (!this._videoHeight && this.media.videoHeight && this.resize(),
                  (this.waitTimer || this.hasClass(wt.LOADING)) &&
                    this.media.readyState > 2 &&
                    (this.removeClass(wt.LOADING),
                    T.clearTimeout(this, this.waitTimer),
                    (this.waitTimer = null)),
                  !this.paused &&
                    this.state === It &&
                    this.duration &&
                    (this.setState(Lt), this.emit($)),
                  this._accPlayed.t ||
                    this.paused ||
                    this.ended ||
                    (this._accPlayed.t = new Date().getTime()));
            ...
            },
            {
              ...
              value: function (e, i, n) {
                if (this.media && i && e) {
                  var o = 'String' === T.typeOf(e) ? e : e.type || '';
                  (n.props &&
                    'Array' !== T.typeOf(n.props) &&
                    (n.props = [n.props]),
                    this.emit(
                      be,
                      t(
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (!a || 0 === a.length || !this.duration) return !0;
                for (
                  var l = e || this.media.currentTime || 0.2,
                    c = a.length,
                    u = 0;
                  u < c;
                  u++
                )
                  if (a.start(u) + o <= l && a.end(u) - s > l) return !0;
                return !1;
              },
            },
            {
              ...
              value: function () {
                ...
                if (!(s < 0 && o < 0 && r < 0)) {
                  ...
                  if (
                    ...
                    this.videoPos.pi = a;
                    var l = { rotate: (s = s < 0 ? 0 : s) },
                      c = 0,
                      u = 0,
                      h = 1,
                      d = Math.abs(s / 90),
                      f = this.root,
                      p = this.innerContainer,
                      g = f.offsetWidth,
                      v = p ? p.offsetHeight : f.offsetHeight,
                      y = {},
                      m = v,
                      k = g;
                    if (d % 2 == 0)
                      ((h = o > 0 ? 100 / o : r > 0 ? 100 / r : 1),
                        (l.scale = h),
                        (c = i > 0 ? (100 - o) / 2 - i : 0),
                        (l.y = 2 === d ? 0 - c : c),
                        (u = n > 0 ? (100 - r) / 2 - n : 0),
                      ...
                      ((u = (-b / 2 / (k = v)) * 100),
                        ...
                        (l.scale = h),
                        (y.width = ''.concat(k, 'px')),
                        (y.maxWidth = ''.concat(k, 'px')),
                        (y.height = ''.concat(m, 'px')),
                        (y.maxHeight = ''.concat(m, 'px')));
                    }
                    var C = T.getTransformStyle(
                      l,
              ...
              value: function () {
                ...
                if (this.media && this.root) {
                  ...
                  if (
                    ...
                    (this.resizePosition(), this.emit(fe, v));
                  }
                }
              },
            },
            ...
            },
            {
              ...
              value: function (e) {
                (_.logInfo(
                  'setState',
                  'state from:'.concat(Ot[this.state], ' to:').concat(Ot[e]),
                ),
                  (this._state = e));
              },
            },
            {
              ...
              value: function (e, t) {
                var i = this.config,
                  n = i.preProcessUrl,
                  o = i.preProcessUrlOptions,
                  r = Object.assign({}, o, t);
                return T.isBlob(e) || 'function' != typeof n
                  ? { url: e }
                  : n(e, r);
              },
            },
            {
              ...
              value: function () {
                this.__startTime > 0 &&
                  this.duration > 0 &&
                  ((this.currentTime =
                    this.__startTime > this.duration
                      ? this.duration
                      : this.__startTime),
                  (this.__startTime = -1));
              },
            ...
            },
            {
              key: 'isPlaying',
              get: function () {
                return this._state === Lt || this._state === At;
              },
              set: function (e) {
                e ? this.setState(Lt) : this._state >= Lt && this.setState(Pt);
              },
            },
            {
              key: 'definitionList',
            ...
            },
            {
              ...
              set: function (e) {
                0 !==
                  Ne.langKeys.filter(function (t) {
                    return t === e;
                  }).length || 'zh' === e
                  ? ((this.config.lang = e), _t.setLang(e, this))
                  : console.error(
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                ('boolean' == typeof t &&
                  ...
                  T.typeOf(t) === Boolean && (this.muted = t)),
                  null === (i = Nt) ||
                    void 0 === i ||
                    i.setActive(this.playerId, e));
              },
            },
          ],
          [
            ...
            },
            {
              ...
              value: function (e, t) {
                var i;
                null === (i = Nt) || void 0 === i || i.setActive(e, t);
              },
            },
            {
              key: 'isHevcSupported',
              value: function () {
                return Ue.isHevcSupported();
              },
            },
            {
              key: 'probeConfigSupported',
              value: function (e) {
                return Ue.probeConfigSupported(e);
              },
            },
            {
              key: 'install',
  ...
  (s(Ft, 'defaultPreset', null),
    s(Ft, 'XgVideoProxy', null),
    (Ft.instManager = Oe.getInstance()));
  var Bt = (function (e) {
    a(i, e);
    var t = d(i);
    function i() {
      ...
      r(
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              return {
                cssFullscreen: { icon: Ut, class: 'xg-get-cssfull' },
                exitCssFullscreen: { icon: Wt, class: 'xg-exit-cssfull' },
              };
            },
          },
          {
            ...
            value: function () {
              if (!this.config.disable)
                return '<xg-icon class=\'xgplayer-cssfullscreen\'>\n    <div class="xgplayer-icon">\n    </div>\n    '.concat(
                  Ht(this, 'CSSFULLSCREEN_TIPS', this.playerConfig.isHideTips),
                  '\n    </xg-icon>',
                );
            },
          },
      ...
      r(
        ...
        [
          ...
          },
          {
            key: 'registerIcons',
            value: function () {
              return { screenBack: { icon: Gt, class: 'xg-fullscreen-back' } };
            },
          },
          {
            key: 'initIcons',
          ...
          },
          {
            key: 'show',
            value: function () {
              T.addClass(this.root, 'show');
            },
          },
          {
            key: 'hide',
            value: function () {
              T.removeClass(this.root, 'show');
            },
          },
          {
            key: 'render',
        ...
        [
          ...
          },
          {
            key: 'defaultConfig',
            get: function () {
              return { position: pt.ROOT_TOP, index: 0 };
            },
          },
        ],
      ),
      ...
      r(
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              return {
                fullscreen: { icon: Kt, class: 'xg-get-fullscreen' },
                exitFullscreen: { icon: qt, class: 'xg-exit-fullscreen' },
              };
            },
          },
          {
            ...
            value: function () {
              (p(l(i.prototype), 'destroy', this).call(this),
                this.unbind(
                  '.xgplayer-icon',
                  'mobile' === Ue.device ? 'touchend' : 'click',
                  this.handleFullscreen,
                ),
                'mobile' === Ue.device &&
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var t = this.player,
                i = this.config;
              !0 === i.useCssFullscreen ||
              ('function' == typeof i.useCssFullscreen && i.useCssFullscreen())
                ? (t.fullscreen ? t.exitCssFullscreen() : t.getCssFullscreen(),
                ...
                : i.rotateFullscreen
                  ...
                  : i.switchCallback && 'function' == typeof i.switchCallback
                    ...
                    : t.fullscreen
                      ? (t.exitFullscreen(),
                        i.useScreenOrientation && this.unlockScreen())
                      : (t.getFullscreen().catch(function (e) {}),
                        i.useScreenOrientation &&
                          t.aspectRatio > 1 &&
                          this.lockScreen(i.lockOrientationType));
            },
          },
          {
            key: 'animate',
            ...
            value: function () {
              if (!this.config.disable) {
                return '<xg-icon class="xgplayer-fullscreen">\n    <div class="xgplayer-icon">\n    </div>\n    '.concat(
                  Ht(this, 'FULLSCREEN_TIPS', this.playerConfig.isHideTips),
                  '\n    </xg-icon>',
                );
              }
            },
          },
          {
            ...
            value: function (e) {
              try {
                screen.orientation.lock(e).catch(function (e) {});
              } catch (t) {}
            },
          },
          {
  ...
  var Jt = (function (e) {
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                return {
                  play: { icon: Xt, class: 'xg-icon-play' },
                  pause: { icon: Zt, class: 'xg-icon-pause' },
                };
              },
            },
            {
              ...
              value: function () {
                if (!this.config.disable)
                  return '<xg-icon class="xgplayer-play">\n    <div class="xgplayer-icon">\n    </div>\n    '.concat(
                    Ht(this, 'PLAY_TIPS', this.playerConfig.isHideTips),
                    '\n    </xg-icon>',
                  );
              },
            },
          ...
          [
            ...
            },
            {
              key: 'defaultConfig',
              get: function () {
                return { position: pt.CONTROLS_LEFT, index: 0, disable: !1 };
              },
            },
          ],
        ),
      ...
      return (
        r(e, [
          ...
          },
          {
            ...
            value: function () {
              ...
              var i = this.playedIndex,
                n = this.cachedIndex;
              if ('Undefined' !== T.typeOf(e.played)) {
              ...
              if ('Undefined' !== T.typeOf(e.cached)) {
          ...
          },
          {
            ...
            value: function () {
              for (var e = this.root.children, t = 0; t < e.length; t++)
                if (T.hasClass(e[t], this.fragConfig.fragFocusClass))
          ...
          },
          {
            ...
            value: function () {
              for (var e = this.root.children, t = 0; t < e.length; t++)
                T.removeClass(e[t], this.fragConfig.fragFocusClass);
            },
          },
          {
            key: 'setHightLight',
            value: function (e) {
              ...
              if (e < t.length)
                return (
                  T.addClass(t[e], this.fragConfig.fragFocusClass),
                  { dom: t[e], pos: t[e].getBoundingClientRect() }
                );
            },
          },
    ...
    ei = { POINT: 'inner-focus-point', HIGHLIGHT: 'inner-focus-highlight' },
    ti = (function (e) {
      a(l, e);
      var o = d(l);
      function l(e) {
        ...
        return (
          ...
          s(u(t), 'onMouseDown', function (e) {
            ...
            if (
              ...
              if (o.duration || o.isPlaying) {
                (e.stopPropagation(),
                  t.focus(),
                  T.checkIsFunction(a.disableSwipeHandler) &&
                    a.disableSwipeHandler(),
                  T.checkIsFunction(s.onMoveStart) && s.onMoveStart(),
                  T.event(e),
                  (r.x = c),
                  (r.isDown = !0),
                  (r.moving = !1),
                  ...
                  T.addClass(t.progressBtn, 'active'));
                ...
                return (
                  ...
                  'touchstart' === e.type
                    ? (t.root.addEventListener('touchmove', t.onMouseMove),
                      ...
                      t.root.addEventListener('touchcancel', t.onMouseUp))
          ...
          s(u(t), 'onMouseUp', function (e) {
            ...
            if (r) {
              (e.stopPropagation(),
                e.preventDefault(),
                T.checkIsFunction(s.enableSwipeHandler) &&
                  s.enableSwipeHandler(),
                T.checkIsFunction(o.onMoveEnd) && o.onMoveEnd(),
                T.event(e),
                T.removeClass(t.progressBtn, 'active'));
          ...
          s(u(t), 'onMouseMove', function (e) {
            var i = u(t),
              ...
              r = i.player,
              s = i.config;
            (T.checkTouchSupport() && e.preventDefault(), T.event(e));
            var a = T.getEventPos(e, r.zoom),
          ...
          (t._disableBlur = !1),
          'boolean' == typeof t.config.isDragingSeek &&
            (console.warn(
              "[XGPLAYER] 'isDragingSeek' is deprecated, please use 'isDraggingSeek' instead",
            ),
            (t.config.isDraggingSeek = t.config.isDragingSeek)),
          t
        );
      }
      return (
          ...
          [
              ...
              value: function () {
                if (!this.config.disable && !this.playerConfig.isLive) {
                  ...
                  (this._initInner(this.config.fragments, {
                    ...
                    'mobile' === Ue.device &&
                      ((this.config.isDraggingSeek = !1), (this.isMobile = !0)),
            ...
            },
            {
              ...
              value: function () {
                this._disableBlur ||
                  ...
                  T.removeClass(this.root, 'active'));
              },
            },
            {
              key: 'disableBlur',
              ...
              value: function (e, t, i, n) {
                ...
                if (!o.isCloseClickSeek || 0 !== n) {
                  ...
                  (this.updatePercent(i),
                    this.updateTime(e),
                    (1 !== n ||
                      (o.isDraggingSeek && 'audio' !== r.config.mediaType)) &&
                      ((this._state.now = s),
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                ((d = d < 0 ? 0 : d > 1 ? 1 : d),
                  Number.isNaN(d) &&
                    (d = this.player.currentTime / this.offsetDuration));
                var f = parseInt(d * this.offsetDuration * 1e3, 10) / 1e3;
                return {
                  percent: d,
                  currentTime: f,
                  seekTime: T.getCurrentTimeByOffset(f, o.timeSegments),
                  offset: h,
                  width: i,
                  left: n,
                  e: e,
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  ((r = T.adjustTimeByDuration(r, n, e)),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (t) {
                  ...
                  ((n = T.adjustTimeByDuration(n, i, e)),
        ...
        r(
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (!i.disable && !this.isActiving && t.hasStart) {
                  ...
                  ((o = T.adjustTimeByDuration(o, n, e)),
                    'flex' === this.mode
                      ? ((this.centerCurDom.innerHTML = this.minWidthTime(
                        ...
                        n !== 1 / 0 &&
                          n > 0 &&
                          (this.centerDurDom.innerHTML = T.format(n)))
                      : ((this.timeDom.innerHTML = this.minWidthTime(
                          T.format(o),
                        )),
                        n !== 1 / 0 &&
                          n > 0 &&
                          (this.durationDom.innerHTML = T.format(n))));
                }
              },
            },
            {
              ...
              value: function () {
                'flex' === this.mode
                  ? ((this.centerCurDom.innerHTML = this.minWidthTime(
                    ...
                    (this.centerDurDom.innerHTML = T.format(0)))
                  : ((this.timeDom.innerHTML = this.minWidthTime(T.format(0))),
                    (this.durationDom.innerHTML = T.format(0)));
              },
            },
            {
              ...
              value: function () {
                ...
                if (e.controls && e.controls.center) {
                  ...
                  ((this.centerCurDom = T.createDom(
                    'xg-icon',
                    '00:00',
                    {},
                    'xgplayer-time xg-time-left',
                  )),
                    (this.centerDurDom = T.createDom(
                      'xg-icon',
                      '00:00',
                      {},
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.duration === 1 / 0 || this.playerConfig.isLive
                  ? (T.hide(this.durationDom),
                    T.hide(this.timeDom),
                    T.hide(this.find('.time-separator')),
                    T.show(this.find('.time-live-tag')))
                  : T.hide(this.find('.time-live-tag')),
              ...
              value: function (e) {
                e
                  ? (T.hide(this.durationDom),
                    ...
                    T.show(this.find('.time-live-tag')))
                  : (T.hide(this.find('.time-live-tag')),
                    T.show(this.find('.time-separator')),
                    T.show(this.durationDom),
                    T.show(this.timeDom));
              },
            },
            {
          ...
          [
            ...
            },
            {
              key: 'defaultConfig',
              get: function () {
                return { position: pt.CONTROLS_LEFT, index: 2, disable: !1 };
              },
            },
          ],
        ),
    ...
    function i() {
      ...
      return (
        ...
        s(u(e), 'onBarMouseMove', function (t) {
          ...
          if (i.isStart) {
            var n = u(e),
              o = n.pos,
              r = n.player;
            (t.preventDefault(), t.stopPropagation(), T.event(t));
            var s = T.getEventPos(t, r.zoom);
            i.isMoving = !0;
        ...
        s(u(e), 'onBarMouseUp', function (t) {
          (T.event(t), document.removeEventListener('mouseup', e.onBarMouseUp));
          var i = u(e)._d;
        ...
        [
          {
            ...
            value: function () {
              return {
                volumeSmall: { icon: oi, class: 'xg-volume-small' },
                volumeLarge: { icon: ni, class: 'xg-volume' },
                volumeMuted: { icon: ri, class: 'xg-volume-mute' },
              };
            },
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                (i.volumeColor &&
                  ...
                  this.on(W, this.onVolumeChange),
                  this.once(V, this.onVolumeChange),
                  'Number' !== T.typeOf(n) &&
          ...
          },
          {
            ...
            value: function () {
              ...
              n.innerText = i ? 0 : Math.round(100 * o);
            },
          },
          {
            key: 'focus',
            value: function () {
              (this.player.focus({ autoHide: !1 }),
                this._timerId &&
                  (T.clearTimeout(this, this._timerId), (this._timerId = null)),
                T.addClass(this.root, 'slide-show'));
            },
          },
          {
            key: 'unFocus',
            value: function () {
              ...
              o.isActive ||
                (this._timerId &&
                  (T.clearTimeout(this, this._timerId), (this._timerId = null)),
                (this._timerId = T.setTimeout(
                  this,
                  function () {
                    (o.isActive ||
                      (i ? r.blur() : r.focus(),
                      T.removeClass(e.root, 'slide-show'),
        ...
        return (
          ...
          s(u(e), '_onReset', function () {
            ((e._state = {
              ...
              (e._isWaiting = !1),
              e._waitTimer && T.clearTimeout(u(e), e._waitTimer),
              e._waittTimer && T.clearTimeout(u(e), e._waittTimer),
              (e._waitTimer = null),
              (e._waittTimer = null),
              (e._waitType = 0));
          }),
          ...
          s(u(e), '_onWaiting', function () {
            !e._isWaiting &&
              ...
              e.vt
                ...
                : (e._waitType = 1),
              (e.fixedWaitingStart = ai()),
              (e._waitTimer = T.setTimeout(
                u(e),
                function () {
                  e._isWaiting &&
                    ((e.waitingStart = ai()),
                    T.clearTimeout(u(e), e._waitTimer),
                    (e._waitTimer = null),
                    e._startWaitTimeout(),
                    e.emitLog(hi, {
                      fixedStart: e.fixedWaitingStart,
        ...
        r(
          ...
          [
                ...
                (this._onReset(),
                  ...
                  this.on(K, function () {
                    var t = e._state,
                      i = t.autoplayStart,
                      n = t.isFFSend;
                    ((e.startCostTime = ai() - e.newPointTime),
                      _.logInfo(
                  ...
                  this.on(j, this._onSeeking),
                  this.on(N, this._onSeeked),
                  this.on(ie, function () {
                    e.endState('destroy');
                  }),
                  this.on(ne, function () {
                  ...
                  this.on([O, B], this._onPlaying),
                  this.on(H, this._onWaiting),
                  this.on(M, this._onError),
                  this.on(Ce, function () {
                    (_.logInfo(
                      '[xgLogger]'.concat(e.player.playerId, ' RESET'),
                    ),
                      e.endState('reset'),
                      e._initOnceEvents(),
                      e._onReset());
            ...
            },
            {
              key: '_initOnceEvents',
              value: function () {
                (this.off($, this._onAutoplayStart),
                  this.off(F, this._onTimeupdate),
                  this.once($, this._onAutoplayStart),
                  this.once(F, this._onTimeupdate));
              },
            },
            {
              key: '_sendFF',
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                (this._waittTimer && T.clearTimeout(this, this._waittTimer),
                  (this._waittTimer = T.setTimeout(
                    this,
                    function () {
                      (e.suspendWaitingStatus('timeout'),
                        T.clearTimeout(e, e._waittTimer),
                        (e._waittTimer = null));
                    },
            ...
            },
            {
              ...
              value: function (e) {
                if (this.seekingStart) {
                  ...
                  ((this.seekingStart = 0),
                    this.emitLog(pi, { end: t, costTime: i, endType: e }));
                }
              },
            },
            {
              ...
              value: function (e) {
                if (
                  (this._waitTimer &&
                    (T.clearTimeout(this, this._waitTimer),
                    (this._waitTimer = null)),
                  this._waittTimer &&
                    (T.clearTimeout(this, this._waittTimer),
              ...
              value: function (e, i) {
                ...
                this.emit(
                  ...
                  t(
                    {
                      t: ai(),
                      host: T.getHostFromUrl(n.currentSrc),
                      vtype: n.vtype,
                      eventType: e,
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                (kt.insert(this.icons.replay, this.root, 0),
                  ...
                  this.on(D, function () {
                    if (
                      (e.playerConfig.loop ||
                        T.addClass(e.player.root, 'replay'),
                      !e.config.disable)
                    ) {
                      e.show();
            ...
            },
            {
              ...
              value: function (e) {
                (e.preventDefault(),
                  e.stopPropagation(),
                  this.player.replay(),
                  T.removeClass(this.player.root, 'replay'));
              },
            },
            {
              key: 'show',
        ...
        r(
          ...
          [
            ...
            },
            {
              key: 'hide',
              value: function () {
                T.addClass(this.root, 'hide');
              },
            },
            {
              key: 'show',
              value: function (e) {
                T.removeClass(this.root, 'hide');
              },
            },
            {
              key: 'beforeCreate',
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                (this.on(D, function () {
                  e.isEndedShow && T.removeClass(e.root, 'hide');
                }),
                  this.config.hideCanplay
                    ? (this.once(F, function () {
                        e.onTimeUpdate();
                      }),
                      this.on(ne, function () {
                        (T.removeClass(e.root, 'hide'),
                          T.addClass(e.root, 'xg-showplay'),
                          e.once(F, function () {
                            e.onTimeUpdate();
                          }));
                      }))
                    : this.on(A, function () {
                        T.addClass(e.root, 'hide');
                      }));
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.player.currentTime
                  ? T.removeClass(this.root, 'xg-showplay')
                  : this.once(F, function () {
                      e.onTimeUpdate();
                    });
              },
            ...
            },
            {
              ...
              value: function () {
                var e = this.config,
                  ...
                  o = e.notHidden,
                  r = this.getBgSize(n),
                  s = t ? 'background-image:url('.concat(t, ');').concat(r) : r;
                return '<xg-poster class="xgplayer-poster '
                  .concat(
                    o ? 'xg-not-hidden' : i ? 'xg-showplay' : '',
                    '" style="',
                  )
                  .concat(s, '">\n    </xg-poster>');
              },
  ...
  function bi(e) {
    e
      ...
      : Object.keys(ki).map(function (e) {
          (window.clearTimeout(ki[e].id), delete ki[e]);
        });
  }
  var Ci = (function (e) {
      a(i, e);
      ...
      function i(e) {
        ...
        return (
          ...
          s(u((o = t.call(this, e))), 'onPlayerReset', function () {
            ...
            (o.setAttr('data-state', 'play'),
              T.removeClass(o.root, e),
              o.show());
          }),
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  t = this.player,
                  i = this.playerConfig;
                (this.once(Z, function () {
                  i &&
                    (i.lang && 'en' === i.lang
                      ? T.addClass(t.root, 'lang-is-en')
                      : 'jp' === i.lang && T.addClass(t.root, 'lang-is-jp'));
                }),
                  this.on($, this.onAutoplayStart),
                  this.on(Q, function () {
                    var t = 'auto' === e.config.mode ? 'auto-hide' : 'hide';
                    (e.setAttr('data-state', 'play'),
                      T.removeClass(e.root, t),
                      e.show());
                  }),
                  this.on(A, function () {
                    e.toggleTo('play');
            ...
            },
            {
              ...
              value: function () {
                return {
                  startPlay: { icon: Xt, class: 'xg-icon-play' },
                  startPause: { icon: Zt, class: 'xg-icon-pause' },
                };
              },
            },
            {
            ...
            },
            {
              key: 'focusHide',
              value: function () {
                T.addClass(this.root, 'focus-hide');
              },
            },
            {
              key: 'recover',
              value: function () {
                T.removeClass(this.root, 'focus-hide');
              },
            },
            {
              key: 'switchStatus',
                ...
                this._animateId = (function (e, t) {
                  var i =
                    arguments.length > 2 && void 0 !== arguments[2]
                      ...
                      : { start: null, end: null };
                  return (
                    ki[e] && window.clearTimeout(ki[e].id),
                    (ki[e] = {}),
                    i.start && i.start(),
                    (ki[e].id = window.setTimeout(function () {
                      (i.end && i.end(),
                        window.clearTimeout(ki[e].id),
                        delete ki[e]);
                    }, t)),
                    ki[e].id
                  );
                  ...
                  start: function () {
                    (T.addClass(t.root, 'interact'),
                      t.show(),
                      t.switchStatus(!0));
                  },
                  end: function () {
                    (T.removeClass(t.root, 'interact'),
                      !e && t.hide(),
                      (t._animateId = null));
                  },
                });
            ...
            },
            {
              key: 'endAnimate',
              value: function () {
                (T.removeClass(this.root, 'interact'),
                  bi(this._animateId),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                e.stopPropagation(),
                t.state < St) ||
                  (this.player.paused || t.state !== Lt ? t.play() : t.pause());
              },
            },
            {
              key: 'onPlayPause',
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.config,
                  i = this.player;
                if (i && !(i.state < Lt) && this.autoPlayStart) {
                  if ('show' === t.mode)
          ...
          [
            {
              ...
              value: function () {
                var e = this.config.innerHtml,
                  t = T.createDom('xg-enter', '', {}, 'xgplayer-enter');
        ...
        r(
          ...
          [
            ...
            },
            {
              key: 'defaultConfig',
              get: function () {
                return { position: pt.CONTROLS_RIGHT, index: 10 };
              },
            },
          ],
        ),
      ...
      return (
        r(i, [
          ...
          },
          {
            key: 'ontouchmove',
            value: function (e) {
              var t = Pi(e.changedTouches, this.touchIdentifier);
              t && this.dragMove(e, t);
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e, t) {
              if (-1 !== e.indexOf('%')) {
                var i = Ei(this._root.parentNode);
        ...
        (n(this, i),
          ...
          s(u(o), 'onScroll', function (e) {
            if (
              ...
              var t = parseInt(T.getCss(o.player.root, 'height'));
        ...
        r(
          ...
          [
              ...
              value: function () {
                ...
                if (!this.config.disable) {
                  if (this.config.isShowIcon) {
                    ...
                    t.controls.registerPlugin(wi, i, wi.pluginName);
                  }
                  var n = T.checkTouchSupport() ? 'touchend' : 'click';
                  (this.bind('.mini-cancel-btn', n, this.onCancelClick),
                    this.bind('.play-icon', n, this.onCenterClick),
                    this.config.disableDrag ||
                      (this._draggabilly = new Di(this.player.root, {
                        handle: this.root,
                      })),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (!this.isMini) {
                  ...
                  ((this.lastStyle = {}),
                    T.addClass(t.root, 'xgplayer-mini'),
            ...
            },
            {
              ...
              value: function () {
                ...
                var t = this.player,
                  i = this.playerConfig,
                  n = this.config.target || this.player.root;
                (T.removeClass(t.root, 'xgplayer-mini'),
                  this.lastStyle &&
            ...
            },
            {
              key: 'updatePos',
              value: function (e) {
                ((this.pos = Object.assign(this.pos, e)),
                  this.isMini &&
                    ((this.player.root.style.left = ''.concat(
                      this.pos.left,
                      'px',
                    )),
                    (this.player.root.style.top = ''.concat(
                      this.pos.top,
                      'px',
                    )),
                    (this.player.root.style.width = ''.concat(
                      this.pos.width,
                      'px',
                    )),
                    (this.player.root.style.height = ''.concat(
                      this.pos.height,
                      'px',
                    ))));
              },
            },
            {
              ...
              value: function () {
                ...
                var e = T.checkTouchSupport() ? 'touchend' : 'click';
              ...
              value: function () {
                if (!this.config.disable)
                  return '\n      <xg-mini-layer class="xg-mini-layer">\n      <xg-mini-header class="xgplayer-mini-header">\n      '.concat(
                    Ht(this, 'MINI_DRAG', this.playerConfig.isHideTips),
        ...
        return (
          ...
          s(u(e), 'onMouseLeave', function (t) {
            ...
            (n ||
              r ||
              (o
                ? e.player.focus({ autoHide: !0, delay: o })
                : e.player.blur({ ignorePaused: !0 })),
              e.emit(re));
          }),
            ...
            },
            {
              ...
              value: function () {
                ...
                (n && n.addEventListener('click', this.onVideoClick, !1),
                  ...
                  Object.keys(Mi).map(function (t) {
                    n.addEventListener(t, e[Mi[t]], !1);
                  }),
                  !o &&
                    i &&
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.clickTimer && clearTimeout(this.clickTimer),
                  ...
                  Object.keys(Mi).map(function (t) {
                    n.removeEventListener(t, e[Mi[t]], !1);
                  }));
              },
            },
          ],
  ...
  var Yi = (function () {
    function e(t) {
      ...
      (n(this, e),
        ...
        (this.root = t),
        (this.events = 'mouse' === o.eventType ? Ki : zi),
          ...
          value: function (e) {
            ...
            (this.pressIntrvalId && this.__clearPress(),
              (this.pressIntrvalId = setTimeout(function () {
                (t.trigger(Fi, e), (t._pos.press = !0), t.__clearPress());
              }, i.pressDelay)));
          },
        },
        {
        ...
        },
        {
          ...
          value: function (e) {
            var t = this,
              i = this.config;
            if (this.dbIntrvalId)
              return (this.__clearDb(), void this.trigger(Bi, e));
          ...
          s(u((o = t.call(this, e))), 'onTouchStart', function (e) {
            ...
            if (a && !n.disableGesture && o.duration > 0 && !i.ended) {
              ((r.isStart = !0),
                ...
                T.checkIsFunction(s.disableSwipeHandler) &&
                  s.disableSwipeHandler(),
                (o.find('.xg-dur').innerHTML = T.format(o.duration)));
          ...
          s(u(o), 'onTouchEnd', function (e) {
            ...
            if (
              ...
              var s = o.config,
                a = s.disableGesture,
                l = s.gestureX;
              (!a && l ? o.endLastMove(n.scope) : (n.time = 0),
                (n.scope = -1),
                o.resetPos(),
                T.checkIsFunction(r.enableSwipeHandler) &&
        ...
        r(
          ...
          [
            ...
            },
            {
              key: 'registerIcons',
              value: function () {
                return { seekTipIcon: { icon: Xi, class: 'xg-seek-pre' } };
              },
            },
            {
              key: 'afterCreate',
              value: function () {
                ...
                var r = this.player.controls;
                (r &&
                  r.center &&
                  (r.center.addEventListener(
                    'touchmove',
                    this.onRootTouchMove,
                    !0,
                  ),
                ...
                if (
                  ...
                  var a = n.plugins.progress;
                  a &&
                    (a.addCallBack('dragmove', function (t) {
                      e.activeSeekNote(t.currentTime, t.forward);
                    }),
                    ['dragend', 'click'].forEach(function (t) {
            ...
            },
            {
              ...
              value: function () {
                ...
                var a = o || t,
                  l = r;
                (a && (this.find('.xg-cur').style.color = a),
                  l && (this.find('.xg-dur').style.color = l),
                  this.config.disableTimeProgress &&
                    T.addClass(this.find('.xg-timebar'), 'hide'));
              },
            },
            {
              key: 'resetPos',
              ...
              value: function (e, t, i, n, o) {
                switch (i) {
                  ...
                  case 1:
                    ...
                    break;
                  case 2:
                    Ue.os.isIos || this.updateVolume(t / o);
                }
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                t.state < Lt
                  ? n.closeVideoClick ||
                    (this.sendUseAction(T.createEvent('click')), t.play())
                  : !i.closedbClick || n.closeVideoClick
                    ...
                    : n.closeVideoClick ||
                      ((t.isActive || i.focusVideoClick) &&
                        (this.sendUseAction(T.createEvent('click')),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                !t.closedbClick &&
                  i.state >= Lt &&
                  (this.sendUseAction(T.createEvent('dblclick')),
                  this.switchPlayPause());
              },
            },
            {
              ...
              value: function (e) {
                ...
                if (i.darkness) {
                  ...
                  ((o = o > i.maxDarkness ? i.maxDarkness : o < 0 ? 0 : o),
                    n &&
                      (n.style.backgroundColor = 'rgba(0,0,0,'.concat(o, ')')),
                    (t.light = o));
                }
              },
            },
              ...
              value: function (e) {
                ...
                if (e && 'number' == typeof e && !o && !n.disableActive) {
                  (e < 0 ? (e = 0) : e > i.duration && (e = i.duration - 0.2),
                    this.changeAction(Ji));
                  var r = i.plugins.start;
                  (r && r.focusHide(),
                    (this.find('.xg-dur').innerHTML = T.format(this.duration)),
                    (this.find('.xg-cur').innerHTML = T.format(e)),
                    (this.find('.xg-curbar').style.width = ''.concat(
                      (e / this.duration) * 100,
                      '%',
                    )),
                    t
                      ? T.removeClass(this.find('.xg-seek-show'), 'xg-back')
                      : T.addClass(this.find('.xg-seek-show'), 'xg-back'),
              ...
              i.ctrlKey
                ...
                : (t.repeat ||
                    ...
                    ((i.target === document.body ||
                      (e.config.isGlobalTrigger && !tn(i.target))) &&
                      e.checkCode(n, !0) &&
                      (r.isBodyKeyDown = !0),
              ...
              var t = this.player,
                ...
                c =
                  e.repeat && this.seekStep >= 4
                    ...
                    : this.seekStep;
              a + c <= l ? (a += c) : (a = l);
              var u = T.getCurrentTimeByOffset(a, s),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var s = {
                currentTime: {
                  from: i,
                  to: (r = T.getCurrentTimeByOffset(r, o)),
                },
              };
        ...
        return (
          s(
            ...
            function () {
              ...
              if (e._checkIfEnabled(n)) {
                var o = T.getIndexByTime(i, n),
                  r = T.getOffsetCurrentTime(i, n, o);
          ...
          s(u(e), '_onLoadedData', function () {
            ...
            if (e._checkIfEnabled(t)) {
              var i = T.getOffsetCurrentTime(0, t);
          ...
          s(u(e), '_onTimeupdate', function () {
            ...
            if (e._checkIfEnabled(n)) {
              var o = n.length;
              e.lastCurrentTime = i;
              var r = T.getIndexByTime(i, n);
              r !== e.curIndex && e.changeIndex(r, n);
              var s = T.getOffsetCurrentTime(i, n, r);
          ...
          [
            {
              ...
              value: function () {
                ((this.curIndex = -1),
                  ...
                  this.updateSegments(),
                  this.on(U, this._onDurationChange),
                  this.on(V, this._onLoadedData),
                  this.on(F, this._onTimeupdate),
                  this.on(j, this._onSeeking),
                  this.on(A, this._onPlay));
              },
            },
            {
              key: 'setConfig',
            ...
            value: function () {
              if (!this.config.disable)
                return '\n    <xg-icon class="xgplayer-rotate">\n      <div class="xgplayer-icon">\n      </div>\n      '.concat(
                  Ht(this, 'ROTATE_TIPS', this.playerConfig.isHideTips),
                  '\n    </xg-icon>',
                );
            },
          },
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                return {
                  pipIcon: { icon: cn, class: 'xg-get-pip' },
                  pipIconExit: { icon: un, class: 'xg-exit-pip' },
                };
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                ((i.textContent = t), e.document.head.appendChild(i));
              },
            },
            {
              key: 'requestPIP',
                ...
                if (this.isPIPAvailable() && !this.isPip)
                  try {
                    ...
                    if (
                      (r &&
                        (t.media.poster =
                          'String' === T.typeOf(r) ? r : r.poster),
                      o.preferDocument && this.isDocPIPAvailable())
                    ) {
                      var s = {};
                      if (o.width && o.height)
                        ((s.width = o.width), (s.height = o.height));
                      else {
                        var a = t.root.getBoundingClientRect();
                      ...
                      documentPictureInPicture
                        ...
                        .then(function (i) {
                          ...
                          var s = n || t.root,
                            ...
                            l = s.previousSibling,
                            c = s.nextSibling;
                          e.copyStyleIntoPiPWindow(i);
                          var u = document.createElement('style');
                          if ((u.append('body{padding:0; margin:0;}'), r)) {
                            var h = '';
                            ('string' == typeof r
                              ? (h = r)
                              : 'function' == typeof r && (h = r.call(o)),
                              h && u.append(h));
                          } else
                            s === t.root &&
                              u.append(
                          ...
                          (i.document.head.append(u),
                            i.document.body.append(s),
                            i.addEventListener(
                              'pagehide',
                              function (t) {
                                (a &&
                      ...
                      i.checkWebkitSetPresentationMode(t.media)
                        ? t.media.webkitSetPresentationMode(
                            'picture-in-picture',
                          )
              ...
              value: function () {
                ...
                try {
                  ...
                  if (this.isPIPAvailable() && this.isPip)
                    ...
                    null !== (t = documentPictureInPicture) &&
                    void 0 !== t &&
                    t.window
                  ...
                  return (console.error('exitPIP', n), !1);
                }
              },
            },
            {
              ...
              get: function () {
                ...
                return (
                  !(
                    !this.isDocPIPAvailable() ||
                    null === (e = documentPictureInPicture) ||
                    void 0 === e ||
                    !e.window
                  ) ||
                  (document.pictureInPictureElement &&
                    document.pictureInPictureElement === t.media) ||
                  t.media.webkitPresentationMode === hn
                );
              },
            },
            {
              ...
              value: function () {
                ...
                return (
                  ('Boolean' === T.typeOf(document.pictureInPictureEnabled) &&
                    document.pictureInPictureEnabled &&
                    (('Boolean' === T.typeOf(e.disablePictureInPicture) &&
                      !e.disablePictureInPicture) ||
                      (e.webkitSupportsPresentationMode &&
                        'Function' ===
                          T.typeOf(e.webkitSetPresentationMode)))) ||
                  this.isDocPIPAvailable()
                );
              },
            },
            {
              ...
              value: function () {
                return (
                  ...
                  /^(https|file)/.test(location.protocol)
                );
              },
            },
            {
              ...
              value: function () {
                if (this.config.showIcon && this.isPIPAvailable())
                  return '<xg-icon class="xgplayer-pip">\n      <div class="xgplayer-icon xg-icon-disable">\n      </div>\n      '.concat(
                    Ht(this, 'PIP', this.playerConfig.isHideTips),
                    '\n    </xg-icon>',
                  );
              },
            },
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                ...
                var e = 'mobile' === Ue.device ? 'touchend' : 'click';
              ...
              value: function () {
                if (this.config.urlList && 0 !== this.config.urlList.length)
                  return '\n     <xg-icon class="xgplayer-playnext">\n      <div class="xgplayer-icon">\n      </div>\n      '.concat(
                    Ht(this, 'PLAYNEXT_TIPS', this.playerConfig.isHideTips),
                    '\n     </xg-icon>\n    ',
                  );
              },
            },
        ...
        return (
          ...
          s(u((o = t.call(this, e))), 'download', function (e) {
            if (!o.isLock) {
              ...
              'String' === T.typeOf(t)
                ? (i = t)
                : 'Array' === T.typeOf(t) && t.length > 0 && (i = t[0].src);
        ...
        r(
              ...
              value: function () {
                if (!this.config.disable)
                  return '<xg-icon class="xgplayer-download">\n   <div class="xgplayer-icon">\n   </div>\n   '.concat(
                    Ht(this, 'DOWNLOAD_TIPS', this.playerConfig.isHideTips),
                    '\n    </xg-icon>',
                  );
              },
            },
          ...
          [
            ...
            },
            {
              key: 'defaultConfig',
              get: function () {
                return { position: pt.CONTROLS_RIGHT, index: 3, disable: !0 };
              },
            },
          ],
        ),
          ...
          [
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                try {
                  ...
                  console.error('MouseEvent unsupported', o);
                }
                i && n.dispatchEvent(i);
              },
            },
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var i = this.config;
                this.shot(i.width, i.height).then(function (e) {
                  (t.emit(ve, e),
                    i.saveImg && t.saveScreenShot(e, i.name + i.format));
                });
              },
            },
            {
    ...
    _n = (function () {
      function e(t) {
        ...
        (i && this.setStyle({ maxHeight: i }),
          ...
          this.renderItemList());
        var o = 'touch' === this.config.domEventType ? 'touchend' : 'click';
        this._delegates = kt.delegate.call(
          this,
          this.root,
          'li',
          o,
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t && T.hasClass(t, 'selected')) return !1;
              var i =
        ...
        return (
          ...
          s(u(i), 'onLeave', function (e) {
            (e.stopPropagation(),
              ...
              i.config.listType !== wn && i.isActive && i.toggle(!1));
          }),
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  t = this.config;
                (this.initIcons(),
                  (Pn = Pn || 'touch' === this.domEventType) &&
                    'mobile' === Ue.device &&
                    t.listType === xn &&
                    (t.listType = wn),
                  t.hidePortrait && T.addClass(this.root, 'portrait'),
                  this.on([fe, le], function () {
                    e._resizeList();
                  }),
                  this.once(B, function () {
                    t.list &&
                      t.list.length > 0 &&
                  ...
                  Pn
                    ? ((t.toggleMode = Sn), (this.activeEvent = 'touchend'))
                    : (this.activeEvent =
                        t.toggleMode === Sn ? 'click' : 'mouseenter'),
                  t.toggleMode === Sn
              ...
              value: function () {
                ...
                (i.length > 0 &&
                  ...
                  n ||
                    (this.appendChild(
                      '.xgplayer-icon',
                      T.createDom('span', '', {}, 'icon-text'),
                    ),
                    T.addClass(this.find('.xgplayer-icon'), 'btn-text')));
              },
            },
            {
              key: 'show',
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                ((this.curIndex = t.to.index),
                  ...
                  (this.config.isItemClickHide || Pn || n === wn) &&
                    this.toggle(!1));
              },
            },
                ...
                var s,
                  ...
                  l = {
                    config: {
                      ...
                      domEventType: Pn ? 'touch' : 'mouse',
                    },
                    root:
                      n.listType === wn
                        ? r.innerContainer || r.root
                        : this.root,
                  };
                if (this.config.isShowIcon) {
                  var c = this.player.root.getBoundingClientRect().height,
                    u = n.listType === Tn ? c - 50 : c;
                  (u &&
                    n.heightLimit &&
                    (l.config.maxHeight = ''.concat(u, 'px')),
                    (this.optionsList = new _n(l)),
                    this.changeCurrentText(),
                    this.show());
                }
                this._resizeList();
              ...
              value: function () {
                if (this.config.heightLimit) {
                  var e = this.player.root.getBoundingClientRect().height,
                    t = this.config.listType === Tn ? e - 50 : e;
                  this.optionsList &&
        ...
        r(
          ...
          [
            ...
            },
            {
              key: 'onItemClick',
              value: function (e, t) {
                p(l(o.prototype), 'onItemClick', this).call(this, e, t);
              ...
              value: function () {
                ...
                ((this.intervalId = 0),
                  ...
                  (this.player.showPrompt = function () {
                    e.showPrompt.apply(e, arguments);
                  }),
              ...
              value: function (e) {
                ...
                if (e) {
                  ...
                  (this.intervalId &&
                    ...
                    T.addClass(this.root, 'show'),
                    'arrow' === i.mode && T.addClass(this.root, 'arrow'),
  ...
  var jn = {
    _updateDotDom: function (e, t) {
      if (t) {
        ...
        ((n.left = ''.concat(i.left, '%')),
          ...
          i.isMini ? T.addClass(t, 'mini') : T.removeClass(t, 'mini'),
          Object.keys(n).map(function (e) {
            t.style[e] = n[e];
          }));
      }
    ...
    createDot: function (e) {
      ...
      if (i && (t && (Mn(e), this._ispots.push(e)), this.ispotsInit || !t)) {
    ...
    positionDot: function (e, t) {
      var i = T.findDom(e, '.xgplayer-spot-pop');
      if (i) {
      ...
      function i(e) {
        ...
        return (
          ...
          s(u((o = t.call(this, e))), 'onMousemove', function (e) {
            o.config.disable ||
              (T.hasClass(e.target, 'xg-spot-content') &&
              o.config.isHideThumbnailHover
                ? o.player.plugins.progress.onMouseLeave(e)
                : (o._state.f || T.hasClass(e.target, 'xg-spot-content')) &&
          ...
          s(u(o), 'onProgressMouseOver', function (e, t) {
            if (
              !o.config.disable &&
              T.hasClass(t.target, 'xgplayer-spot') &&
              !o._curDot
            ) {
              ((o._curDot = t.target),
                o.focusDot(t.target),
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  t &&
                  (Object.keys(Nn).map(function (i) {
                    ((e[Nn[i]] = e[Nn[i]].bind(e)), t.addCallBack(i, e[Nn[i]]));
                  }),
                  'mobile' !== Ue.device)
                ) {
                  ...
                  ((this.handlerPreviewClick = function (n) {
                    (n.stopPropagation(),
                      i(parseInt(1e3 * e._state.now, 10) / 1e3, n),
                      t && t.onMouseUp(n));
                  }),
                    this.bind(
                      '.xg-spot-content',
            ...
            },
            {
              ...
              value: function (e) {
                !this.config.disable &&
                  this.player.duration &&
                  ((this.isDrag = !0),
                  this.videoPreview && T.addClass(this.videoPreview, 'show'));
              },
            },
            {
              ...
              value: function (e) {
                !this.config.disable &&
                  ...
                  ((this.isDrag = !1),
                  this.videoPreview &&
                    T.removeClass(this.videoPreview, 'show'));
              },
            },
            {
              key: 'onProgressClick',
            ...
            },
            {
              ...
              value: function (e, t, i, n) {
                ...
                if (o) {
                  ...
                  var a = this.timeStr;
                  (n && n.target && T.hasClass(n.target, 'xgplayer-spot')
              ...
              value: function () {
                ...
                if ('mobile' !== Ue.device) {
                  ...
                  if (
                    ...
                    (T.removeClass(this.root, 'short-line no-thumbnail'),
                      'short' === i.mode && T.addClass(this.root, 'short-line'),
                      (this._hasThumnail = !0));
                  ...
                  } else T.addClass(this.root, 'short-line no-thumbnail');
                }
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                e && (T.removeClass(e, 'active'), (this._activeDotId = null));
              },
            },
            {
              key: 'showTips',
              value: function (e, t) {
                var i =
                  arguments.length > 2 && void 0 !== arguments[2]
                    ? arguments[2]
                    : '';
                (T.addClass(this.root, 'no-timepoint'),
                  e &&
                    (T.addClass(this.find('.xg-spot-content'), 'show-text'),
                    t && 'production' === this.config.mode
                      ? (T.addClass(this.root, 'product'),
                        (this.tipText.textContent = e))
                      : (T.removeClass(this.root, 'product'),
            ...
            },
            {
              key: 'hideTips',
              value: function () {
                (T.removeClass(this.root, 'no-timepoint'),
                  (this.tipText.textContent = ''),
                  T.removeClass(this.find('.xg-spot-content'), 'show-text'),
                  T.removeClass(this.root, 'product'));
              },
            },
            {
      ...
      function i() {
        ...
        return (
          s(
            ...
            'onTimeupdate',
            function () {
              var t = e.player.ended,
                i = u(e).offsetDuration,
                n = e.currentTime;
              ((n = T.adjustTimeByDuration(n, i, t)),
                e.update({ played: n }, i));
            },
          ),
          e
              ...
              value: function () {
                ...
                if (e.miniprogress) {
                  var i = this.config,
                    ...
                    o = i.height,
                    r = {
                      cached: Bn(t.cachedColor),
                      played: Bn(t.playedColor),
                      progress: Bn(t.progressColor),
                      height:
                        o > 0 && 2 !== o ? 'height: '.concat(o, 'px;') : '',
                    };
                  return '<xg-mini-progress class="xg-mini-progress '
                    .concat(
                      'show' === n ? 'xg-mini-progress-show' : '',
                      '" style="',
                    )
                    .concat(r.progress, ' ')
                    .concat(
        ...
        return (
          s(
            ...
            function (t) {
              e.player &&
                ...
                e.off(F, e.renderOnTimeupdate),
                e.on(F, e.renderOnTimeupdate));
            },
          ),
          ...
          s(u(e), 'renderOnTimeupdate', function (t) {
            if (e._frameCount > 0) (e.renderOnce(), e._frameCount--);
              ...
              ((e._isLoaded = !0), e.off(F, e.renderOnTimeupdate));
              ...
              n.videoWidth &&
                ...
                ((e.videoPI =
                  n.videoHeight > 0
                    ...
                    : 0),
                (e.config.mode === Wn || o - e.preTime >= i) &&
                  (n && n.videoWidth && e.update(r, e.videoPI),
                  (e.preTime = o))),
              (e.frameId =
                'timer' === e._loopType
                  ? T.setTimeout(u(e), e.start, i)
                  : T.requestAnimationFrame(e.start)));
          }),
          s(u(e), 'stop', function () {
            e.frameId &&
              ('timer' === e._loopType
                ? T.clearTimeout(u(e), e.frameId)
                : T.cancelAnimationFrame(e.frameId),
              (e.frameId = null));
          }),
          e
        );
        ...
        r(
          ...
          [
            {
              ...
              value: function () {
                ...
                n ||
                  ...
                  (this._frameCount = 0),
                  (this._loopType =
                    this.config.mode !== Wn && this.interval >= 1e3
                      ? 'timer'
                      : 'animation'),
                  this.once(ee, function () {
                    e.player &&
                  ...
                  e && e instanceof window.HTMLVideoElement
                    ...
                    : e.canvas
                      ...
                      : e.flyVideo
                        ? e.flyVideo
                        : null;
                if (t && ('safari' !== Ue.browser || !T.isMSE(t))) return t;
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  this._isLoaded && !this.player.paused && e !== Vn && e !== Gn
                );
              },
            },
            {
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                return !('safari' === Ue.browser || 'firefox' === Ue.browser);
              },
            },
          ],
        ),
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                (this.reset(),
                  this.on(be, this._recordUserActions),
                  this.on(Xn.STATS_INFO, this._recordInfo),
                  this.on(Xn.STATS_DOWNLOAD, this._downloadStats),
                  this.on(Xn.STATS_RESET, this._onReset));
              },
            },
            {
              key: 'destroy',
            ...
            },
            {
              ...
              value: function () {
                var e;
                this._stats = (s((e = {}), Yn, []), s(e, 'media', {}), e);
              },
            },
            {
              key: 'getStats',
  ...
  Jn.BROWSER_GAP_TOLERANCE = 0.001;
  var $n = (function (e) {
      a(i, e);
      var t = d(i);
      function i() {
        ...
        return (
          ...
          s(u(e), 'onJump', function () {
            ...
            if (
              ...
              o > i.media.duration || (e.jumpCnt++, (i.currentTime = o));
            }
          }),
          e
        );
          ...
          [
            {
              ...
              value: function () {
                ...
                !1 !== i &&
                  ...
                  (this.timer = null),
                  (this.jumpSize = n),
                  this.on(H, this.onWaiting),
                  this.on([O, B], function () {
                    (clearTimeout(e.timer),
                      (e.timer = null),
      ...
      function i() {
        ...
        return (
          ...
          s(u(e), '_onRealSpeedChange', function (t) {
            t.speed && e.appendList(t.speed, t.type || Qn);
          }),
            ...
            if (o)
              if (t === Qn)
                (o.avgSpeed && i === o.avgSpeed) ||
                  ((o.avgSpeed = i),
                  o.emit(oe, { speed: i, realTimeSpeed: o.realTimeSpeed }));
              else {
          ...
          [
            {
              ...
              value: function () {
                ...
                ((null == i ? void 0 : i.length) > 0 && eo.push.apply(eo, g(i)),
                  this.initSpeedList(),
                  this.on('real_time_speed', this._onRealSpeedChange),
                  (this.timer = null),
                  (this.cnt = 0),
                  (this.xhr = null),
                  t && this.on([V, te], this.startTimer));
              },
            },
            {
              key: 'getSpeedName',
        ...
        r(
          ...
          [
            ...
            },
            {
              key: '_checkBuffer',
              value: function (e, t) {
                for (var i = !1, n = [], o = 0; o < t.length; o++) {
                  var r = t.start(o),
                    s = t.end(o);
                  if ((n.push({ start: r, end: s }), r <= e && e <= s - 1)) {
                    i = !0;
                    break;
                  }
                }
                return { enoughBuffer: i, buffers: n };
              },
            },
            {
              key: '_checkStuck',
              value: function (e, t, i, n) {
                var o = this.player.media || this.player.video,
                  r = document.hidden,
                  s = o.paused,
                  a = o.readyState,
                  l = o.currentTime,
                    ...
                    (e <= this.config.reportFrame
                      ? (this._currentStuckCount++,
                        ...
                        this._currentStuckCount >= this.config.stuckCount &&
                          (this.emit(Se, this._payload), this._reset()))
                      : this._reset());
                }
              },
            },
              ...
              value: function () {
                ...
                if (e) {
                  var t = e.getVideoPlaybackQuality(),
                    i = t.totalVideoFrames,
                    n = t.droppedVideoFrames,
                    o = performance.now();
                  if (i && this._lastCheckPoint) {
                    var r = i - this._lastDecodedFrames,
                      s = o - this._lastCheckPoint;
                    this._checkStuck(r, i, n, s);
                  }
                  ((this._lastDecodedFrames = i), (this._lastCheckPoint = o));
                }
              },
            },
            {
  ...
  var no = r(function e(t, i) {
      var o, r, s;
      n(this, e);
      var a = i && 'mobile' === i.isMobileSimulateMode,
        l = i.isLive,
        c = [].concat(l ? [] : [sn, ti, Un, Fn, ii], [
          Jt,
          Yt,
          ln,
          vn,
        ...
        u = [yi, mi, Ci, rn, _i, On, Dn, Hn, Ri];
      this.plugins = [Zn, gi].concat(g(c), u, [Jn, $n]);
      var h = a ? 'mobile' : Ue.device;
      switch (h) {
        case 'pc':
          (o = this.plugins).push.apply(o, [nn, Ni, Vt, to, io]);
          break;
        case 'mobile':
          (r = this.plugins).push.apply(r, [en]);
          break;
        default:
          (s = this.plugins).push.apply(s, [nn, Ni, Vt]);
      }
      ((Ue.os.isIpad || 'pc' === h) && this.plugins.push(qn),
        Ue.os.isIpad && this.plugins.push(Ni),
        (this.ignores = []),
        (this.i18n = []));
    }),
    oo = (function (e) {
  ...
  return (
    ...
    s(oo, 'TimeIcon', ii),
    s(oo, 'Progress', ti),
    s(oo, 'FullscreenIcon', Yt),
    s(oo, 'CssFullscreenIcon', Vt),
    s(oo, 'VolumeIcon', si),
    oo
  );
});
